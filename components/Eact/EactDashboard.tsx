...
//         <KpiCard label="Encerradas" value={encerradas.current} deltaPct={encerradas.deltaPct} icon={Building2} accent="red" emphasis />
//         <KpiCard label="Entidades Soltas" value={soltas.current} deltaPct={soltas.deltaPct} icon={Unlink} accent="ink" />
//       </div>
