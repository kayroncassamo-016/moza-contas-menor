...
//  * limite de string do JavaScript no browser (SheetJS falha nesse tamanho).
//  * Por isso o ficheiro é enviado para /api/eact, que o lê em streaming
//  * (exceljs) no servidor.
//  *
//  * Regras aplicadas lá:
...
// // ---------------------------------------------------------------------------
// // Leitura do Plano de Actividades — linhas "Encerradas" e "Entidades Soltas"
// // (rótulos únicos na folha, sem necessidade de escopar por secção).
// // ---------------------------------------------------------------------------
...
//   const res = await fetch("/api/eact", {
//     method: "POST",
//     body: form,
//   });
...
//   if (!res.ok) {
//     console.error("Erro recebido de /api/eact:", {
//       status: res.status,
//       statusText: res.statusText,
//       body,
//     });

//     throw new EactParseError(
//       body.detalhes
//         ? `${body.error ?? "Erro no servidor"}: ${body.detalhes}`
//         : body.error ??
//             `Não consegui processar o ficheiro EACT no servidor. HTTP ${res.status}`
//     );
//   }

//   return body as EactRawResult;
